...
export default function NovoClientePage() {
    ...
    return (
        <main className="space-y-8">
            <div>
                <p className="text-xs font-semibold tracking-[0.20em] text-zinc-500 uppercase">CLIENTES</p>

                <h1 className="mt-3 text-5xl font-bold text-white">Novo Cliente</h1>

                <p className="mt-2 text-zinc-400">Cadastro de novo cliente.</p>
            </div>
            ...
            <div className="max-w-3xl rounded-3xl border border-zinc-800 bg-gradient-to-b from-[#171F2B] to-[#111827] p-8">
                ...
                <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                        <div>
                            ...
                            <input
                                value={rua}
                                readOnly
                                className="mt-2 w-full rounded-xl border border-zinc-800 bg-zinc-900 p-4 text-zinc-500"
                            />
                        </div>
                    ...
                    <button
                        ...
                        className="inline-flex items-center gap-2 rounded-xl bg-green-500 px-8 py-4 font-bold text-black shadow-lg shadow-green-500/20 transition hover:-translate-y-0.5 hover:bg-green-400"
                    >
                        <UserPlus size={20} />
                        Salvar Cliente
                    </button>
