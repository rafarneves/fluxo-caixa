    ...
    <div className="space-y-10">
      <div className="flex items-start justify-between">
        ...
        <Link
          href="/clientes/novo"
          prefetch={false}
          className="rounded-2xl bg-green-500 px-6 py-4 font-bold text-black transition hover:bg-green-400 hover:-translate-y-0.5"
        >
          + Novo Cliente
        </Link>
      </div>
              ...
              return (
                ...
                >
                  ...
                  <td className="p-5 text-right">
                    <Link
                      href={`/clientes/${cliente.id}`}
                      className="rounded-xl bg-green-500/10 px-4 py-2 text-sm text-green-400 mr-2"
                    >
                      Ver
                    </Link>
