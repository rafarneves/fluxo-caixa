      ...
      <div className="rounded-3xl border border-zinc-800 bg-gradient-to-br from-[#171F2B] to-[#111827] p-8 shadow-2xl">
        ...
        <div className="grid gap-7">
          <div>
            ...
            <select
              ...
              className="w-full rounded-2xl border border-zinc-700 bg-[#0F172A] px-5 py-4 text-white outline-none transition-all duration-300 focus:border-green-500 focus:ring-2 focus:ring-green-500/30"
            >
        ...
        <div className="flex justify-end mt-10">
          <button
            ...
            disabled={salvando}
            className="flex items-center gap-3 bg-green-500 hover:bg-green-400 disabled:opacity-60 disabled:cursor-not-allowed text-black font-bold px-8 py-4 rounded-2xl transition-all duration-300 hover:-translate-y-1 shadow-lg shadow-green-500/20"
          >
            <Save size={20} />
