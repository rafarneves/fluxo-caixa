...
export default async function RelatorioRentabilidadeContratosPage() {
  ...
  return (
    <main className="space-y-8">
      ...
      <section className="rounded-3xl border border-zinc-800 bg-[#111827] overflow-hidden">
              ...
              <tr key={item.id} className="border-b border-zinc-800">
                ...
                <td className="px-6 py-5 text-center">
                  <button
                    ...
                    className="inline-flex items-center gap-2 rounded-lg bg-green-500 px-4 py-2 text-sm font-semibold text-black cursor-pointer"
                  >
                    <Eye size={16} />
                    Ver detalhes
                  </button>
