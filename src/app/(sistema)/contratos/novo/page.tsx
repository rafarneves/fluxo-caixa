...
export default function NovoContratoPage() {
  ...
  return (
    <main className="space-y-8">
      <div>
        <p className="text-xs font-semibold uppercase tracking-[0.22em] text-zinc-500">CONTRATOS</p>
      ...
      {mensagem && (
        <div className="rounded-2xl border border-green-500/30 bg-green-500/10 p-5 text-green-400 font-semibold">
          ✓ {mensagem}
        </div>
      )}
      ...
      <form
        ...
        className="max-w-5xl rounded-3xl border border-zinc-800 bg-gradient-to-b from-[#171F2B] to-[#111827] p-8 space-y-8"
      >
        ...
        <div>
          ...
          <select
            ...
            className="mt-2 w-full bg-[#0B0F14] border border-zinc-800 rounded-xl p-4"
          >
        ...
        <div className="flex gap-4">
          <button
            ...
            className="bg-green-500 hover:bg-green-400 disabled:opacity-50 text-black px-8 py-4 rounded-xl font-bold transition"
          >
