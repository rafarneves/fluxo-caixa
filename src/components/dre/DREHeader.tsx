    ...
    return (
        <div className="flex flex-col gap-6 xl:flex-row xl:items-start xl:justify-between">
            ...
            <div className="flex flex-col items-end gap-4">
                ...
                <button className="inline-flex items-center gap-3 rounded-2xl bg-green-500 px-6 py-4 font-semibold text-black transition-all duration-300 hover:scale-[1.02] hover:bg-green-400">
                    <Download size={20} />
                    Exportar DRE
                </button>
            </div>
