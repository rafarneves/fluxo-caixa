...
export default function DREIndicators({
  receitaBruta,
  custos,
        ...
        {indicadores.map((item) => {
          ...
          return (
            <div
              ...
              className="group rounded-2xl border border-zinc-800 bg-black/20 p-5 cursor-pointer transition-all duration-300 hover:-translate-y-1 hover:border-zinc-600 hover:shadow-xl"
            >
