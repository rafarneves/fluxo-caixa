...
export default function DREStatement({ receitaBruta, custos, despesasOperacionais, despesas }: Props) {
    ...
    return (
        <section className="overflow-hidden rounded-3xl border border-zinc-800 bg-gradient-to-b from-[#171F2B] to-[#111827]">
            <div className="border-b border-zinc-800 p-8">
                <div className="group flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="mt-1 text-zinc-500">Visão detalhada da formação do resultado</p>
                    </div>
                </div>
            </div>
            ...
            <div className="space-y-5 p-8">
                ...
                />
                <div className="rounded-2xl border border-zinc-800 bg-black/20 p-6 transition-all duration-300 hover:-translate-y-0.5 hover:border-zinc-600 hover:shadow-xl">
                    <p className="text-zinc-400">Lucro Bruto</p>

                    <div className="mt-3 flex items-center justify-between">
                        <strong className={`text-3xl ${lucroBruto >= 0 ? 'text-green-400' : 'text-red-400'} `}>
                            {moeda(lucroBruto)}
                        </strong>
                ...
                <div className="mt-8 rounded-3xl border border-green-500/20 bg-green-500/10 p-7 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
