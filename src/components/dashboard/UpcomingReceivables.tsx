    ...
    <section className="rounded-3xl border border-zinc-800 bg-gradient-to-b from-[#171F2B] to-[#111827] p-8">
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="text-right">
          <p className="text-3xl font-bold text-green-400">{formatCompact(total)}</p>

          <p className="text-xs uppercase tracking-[0.18em] text-zinc-500">Total Previsto</p>
        </div>
      </div>
      ...
      <div className="space-y-3">
        ...
        {lista.map((item) => (
          ...
          >
            ...
            <div className="text-right">
              <p className="text-2xl font-bold text-white">{formatCompact(Number(item.valor))}</p>
